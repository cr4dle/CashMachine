[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(CashMachine.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(CashMachine.App_Start.NinjectWebCommon), "Stop")]
...
namespace CashMachine.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            //kernel.Bind<IWithdrawService>().To<CashMachineService>().InRequestScope();
